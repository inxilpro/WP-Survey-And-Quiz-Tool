<div class="wrap">
	...
	<h3>Quizes</h3>
		...
		<p>To create a quiz you need to go to <strong>`<em>Quizzes/Surveys</em>`</strong> -&gt; then click <strong>`</strong><em>Add New Quiz</em>`</strong> button. Then complete the form and click the <strong>`<em>Save Quiz</em>`</strong> button.</p>
		
		<a name="edit_a_quiz"></a>
		<h4>How to edit a quiz?</h4>	
		<p>To edit a quiz you need to goto <strong>`<em>Quizzes</em>`</strong> then locate the quiz in the table list. When quiz is located click <strong>`<em>Edit</em>`</strong>.</p>
	
		<a name="delete_a_quiz"></a>
		<h4>How to delete a quiz?</h4>	
		<p>To delete a quiz you need to go to <strong>`<em>Quizzes</em>`</strong> then locate the quiz in the table list. When quiz is located click <strong>`<em>Delete</em>`</strong>.</p>
	...
	<h3>Survey</h3>
		...
		<a name="create_a_survey"></a>
		<h4>How to create a survey?</h4>	
		<p>To create a quiz you need to go to <strong>`<em>Quizzes/Surveys</em>`</strong> -&gt; then click <strong>`</strong><em>Add New Survey</em>`</strong> button. Then complete the form and click the <strong>`<em>Save Survey</em>`</strong> button.</p>
		
		<a name="edit_a_survey"></a>
		<h4>How to edit a survey?</h4>	
		<p>To edit a quiz you need to goto <strong>`<em>Quizzes/Surveys</em>`</strong> then locate the survey in the table list. When survey is located click <strong>`<em>Edit</em>`</strong>.</p>
	
		<a name="delete_a_survey"></a>
		<h4>How to delete a survey?</h4>	
		<p>To delete a quiz you need to go to <strong>`<em>Quizzes/Surveys</em>`</strong> then locate the survey in the table list. When survey is located click <strong>`<em>Delete</em>`</strong>.</p>
	
		<a name="how_many_survey"></a>
		<h4>How many quizzes can I have?</h4>	
		<p>You can have as many as you would like. If you have issues create new surveys please report this to us.</p>
	...
	<h3>Questions</h3>
		...
		<p>To create a question <strong>`<em>Quizzes/Surveys</em>`</strong> -&gt; <strong>`<em>Quiz/Survey</em>`</strong> then locate the quiz you wish to add questions too in the table list. Click <strong>`<em>Edit Questions</em>`</strong> then fill out the form. You will then see a list of questions to add a new question click <strong>`<em>Add New Question</em>`</strong> and fill out the form. Questions must be assigned to a section for them to be displayed!</p>
		
		<a name="edit_a_question"></a>
		<h4>How do I edit a question?</h4>	
		<p>To edit a quiz you need to go to <strong>`<em>Quizzes/Surveys</em>`</strong> -&gt; <strong>`<em>Quiz/Survey</em>`</strong> then locate the quiz in the table list. When quiz is located click <strong>`<em>Edit</em>`</strong> you will then see a list of questions locate the question you wish to edit and then click the <strong>`<em>Edit</em>`</strong> and fill out form accordingly.</p>
			
		<a name="delete_a_question"></a>
		<h4>How do I delete a question?</h4>	
		<p>To edit a quiz you need to go to <strong>`<em>Quizzes/Surveys</em>`</strong> -&gt; <strong>`<em>Quiz/Survey</em>`</strong> then locate the quiz in the table list. When quiz is located click <strong>`<em>Edit</em>`</strong> you will then see a list of questions locate the question you wish to edit and then click the <strong>`<em>Delete</em>`</strong> and then confirm.</p>
	...
	<h3>Sections</h3>
		...
		<p>To create a section you need to go to <strong>`<em>Quizzes/Surveys</em>`</strong> then locate the quiz for which the section belongs to then click <strong>`<em>Sections </em>`</strong> link. Then complete the form and click the <strong>`<em>Save</em>`</strong> button.</p>
		
		<a name="edit_a_section"></a>
		<h4>How to edit a section?</h4>	
		<p>To create a section you need to go to <strong>`<em>Quizzes/Surveys</em>`</strong> then locate the quiz for which the section belongs to then click <strong>`<em>Sections </em>`</strong> link. Then edit form and click the <strong>`<em>Save</em>`</strong> button.</p>
	
		<a name="delete_a_section"></a>
		<h4>How to delete a section?</h4>	
		<p>To delete a section you need to go to <strong>`<em>Quizzes/Surveys</em>`</strong> then locate the quiz for which the section belongs to then click <strong>`<em>Sections </em>`</strong> link. Then empty the section's name and then click the <strong>`<em>Save</em>`</strong> button.</p>
