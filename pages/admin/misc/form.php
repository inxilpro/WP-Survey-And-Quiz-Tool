		...
		<tbody>
			...
			<tr>
				...
				<?php switch ($option["type"]) {
					case "text": ?>
				<input id="<?php echo $name; ?>" maxlength="255" size="50" name="<?php echo $name; ?>" value="<?php echo $option["value"]; ?>" />
				<?php
						 break;
					case "select":						
						?>						
					...
					case "textarea":
						?>						
						<textarea name="<?php echo $name; ?>" rows="8" cols="40"><?php echo $option["value"]; ?></textarea>
						<?php 						
						break;
					case "static":						
						?>						
